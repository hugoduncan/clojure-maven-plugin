 ...
 */
public class ClojureSwankCljMojo extends AbstractClojureCompilerMojo {
    ...
    public void execute() throws MojoExecutionException {
        ...
        sb.append("(do ");
        sb.append("(swank-clj.socket-server/start {");
        sb.append(" :port-file \"");
        ...
        args.add("-e");
        args.add("(require (quote swank-clj.socket-server))");
        args.add("-e");
